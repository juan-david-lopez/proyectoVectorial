...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("esta es la tendencia limite: "+funcionVecto.getTendenciaLimite());
        ...
        if(comprobar){
            ...
            for (int i = 0; i <funcionVecto.getFunciones().length; i++) {
                ...
                System.out.println(" esta es la evaluacion de la funcion "+funcionVecto.getFunciones()[i]+" :"+logica1.evaluarFuncion(funcionVecto.getTendenciaLimite(),funcionVecto.getFunciones()[i]));
                limites[i]= limite;
        ...
        System.out.println(Arrays.toString(funcionVecto.getFunciones()));
